...
### Recommended Binary Model (p < 0.10, VIF < 5)
...
| Model | Factors | Gini | AUROC | AIC | Notes |
|-------|---------|------|-------|-----|-------|
| Best Binary (7f) | `LTV_norm, DSU_BEN_norm, IRR_norm, DSCR_norm, LLCR_norm, IND_...` | 0.9061 | 0.9531 | - | p > 0.05, quasi-separation |
| Recommended Binary (4f) | `DSU_BEN_norm, LLCR_norm, IND_FACTOR_norm, REG_FACTOR_norm` | 0.8357 | 0.9178 | 34.2 | p < 0.10, VIF = 1.03 |
| Best Ordinal (7f) | `LTV_norm, DSU_BEN_norm, IRR_norm, DSCR_norm, LLCR_norm, IND_...` | 0.6832 | 0.8416 | - | Exact match: 61.0% |
| Recommended Ordinal (4f) | `DSU_BEN_norm, IRR_norm, IND_FACTOR_norm, REG_FACTOR_norm` | 0.6634 | 0.8317 | - | Exact match: 61.0%, p < 0.10 |
...
### Comparison Table (Best Ordinal Model)
